...
class InventryList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      userData: [],
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="d-flex justify-content-between">
                <h4 className="mt-3">List of Inventry</h4>
                <button
                  className="btn btn-dark m-2"
                  onClick={this.addNewUser}
                >
                  <AiOutlinePlus /> Create New Checkout
                </button>
              </div>
              <div
                className="card"
...
export default withRouter(InventryList); 
